    ...
    <div className="min-h-screen md:grid md:grid-cols-[280px_1fr]">
      <aside className="agri-glass border-l border-r-0 border-white/10 p-6 md:sticky md:top-0 md:h-screen md:overflow-y-auto">
        <div className="mb-8 flex items-center gap-3">
          <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-emerald-400/90 text-lg font-black text-agri-ink">A</div>
          <div>
        ...
        <Panel className="mt-8 p-4 text-sm">
      ...
      <div className="min-w-0">
        <header className="sticky top-0 z-40 border-b border-white/10 bg-agri-base px-5 py-4 backdrop-blur-xl md:px-8">
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              <Badge>API Sync: Active</Badge>
              <ButtonLink href="/app/reports" variant="solid" size="sm">
                إنشاء تقرير
              </ButtonLink>
            </div>
          </div>
