...
export function ReportCard({
  ...
  return (
    <article className="group flex h-full flex-col rounded-2xl border border-white/10 bg-white/[0.03] p-5 text-right transition hover:border-emerald-400/40 hover:bg-white/[0.05]">
      ...
      <p className="mt-2 text-xs text-slate-500">آخر مزامنة: اليوم 05:05 ص • ثقة البيانات: 96%</p>
